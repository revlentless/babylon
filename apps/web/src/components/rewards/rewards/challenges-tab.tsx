...
export function ChallengesTab({ onViewAchievements }: ChallengesTabProps) {
  ...
  const dailyCompleted = useMemo(
    () => challengesData.daily.challenges.filter((c) => c.completed).length,
    [challengesData.daily.challenges]
  );
  const weeklyCompleted = useMemo(
    () => challengesData.weekly.challenges.filter((c) => c.completed).length,
    [challengesData.weekly.challenges]
  );
  ...
  const weeklyChallengeCards = useMemo(
    () =>
